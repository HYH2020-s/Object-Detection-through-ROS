#download the repo at:https://github.com/lyxok1/Tiny-DSOD and follow the instructions(need install caffe)

#running command demo: python examples/DCOD/image_detection_demo.py -model /home/reg1s/Postgraduate/TeamProject/model/Tiny-DSOD/deploy.prototxt -weights /home/reg1s/Postgraduate/TeamProject/model/Tiny-DSOD/Tiny-DSOD.caffemodel -img_dir /home/reg1s/Postgraduate/TeamProject/Data/14/ -num 10 -gpu
...
sys.path.append('/home/reg1s/Postgraduate/TeamProject/model/Tiny-DSOD/Tiny-DSOD/python')
#sys.path.append('/home/reg1s/Caffe/caffe-master/python')
...
if __name__ == '__main__':
    ...
    for i in range(args.num):
        ...
        for k in range(top_conf.shape[0]):
            ...
            #print('pic:',str(i),' label_name:',label_name)
        ...
        print('FPS:', 1/elapsed_time, 'time:', elapsed_time)
